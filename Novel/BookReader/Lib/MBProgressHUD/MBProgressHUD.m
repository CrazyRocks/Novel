...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    ...
    NSMutableDictionary *detaileAttrs = [NSMutableDictionary dictionary];
    detaileAttrs[NSFontAttributeName] = detailsLabel.font;
    
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:detaileAttrs context:nil].size;
//
